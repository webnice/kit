...
import (
	...
	_ "github.com/webnice/kit/application/component/configuration"  // Конфигурация и выполнение команды version.
	_ "github.com/webnice/kit/application/component/daemon"         // Работники, процессы, службы приложения.
	...
	_ "github.com/webnice/kit/application/component/migrations"     // Применение миграций базы данных.
	...
	_ "github.com/webnice/kit/application/component/test" // Тестовая компонента.
)
