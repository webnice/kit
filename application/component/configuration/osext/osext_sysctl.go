...
func (ost *impl) makeMIB() (mib [4]int32) {
	switch runtime.GOOS {
	case osFreebsd:
...
func (ost *impl) makeExecPath(buf []byte, n uintptr) (ret string) {
	var (
		i int
		v byte
	)
...
func (ost *impl) makeExecPathOpenBSD(buf []byte, n uintptr) (execPath string) {
	var (
		args []string
		argv uintptr
		argp *[1048576]byte
...
func (ost *impl) getAbs(execPath string) (ret string, err error) {
	if ost.we != nil {
