...
const (
	defaultDatabusBufferLength = 1000000 // Размер буферизированного канала шины данных по умолчанию.
	defaultWorkerCount         = 1000    // Количество параллельно работающих обработчиков, обслуживающих канал данных.
)
